...
public class GenreTest {
    ...
    public void givenInvalidNameWithLengthGreaterThan255_whenCallNewGenreAndValidate_shouldReceiveAError() {
        final var expectedName = """
                ...
                Suco de cevadiss, é um leite divinis, qui tem lupuliz, matis, aguis e fermentis. Delegadis gente finis,
                bibendum egestas augue arcu ut est. A ordem dos tratores não altera o pão duris.                
                A ordem dos tratores não altera o pão duris. Atirei o pau no gatis, per gatis num morreus. 
                Interagi no mé, cursus quis, vehicula ac nisi. Não sou faixa preta cumpadi, sou preto inteiris, inteiris.
                """;
        final var expectedIsActive = true;
        final var expectedErrorCount = 1;
